			...
			<ul>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						@can('view-expired-products')<li><a class="{{ route_is('expired') ? 'active' : '' }}" href="{{route('expired')}}">Périmé</a></li>@endcan
					</ul>
				</li>
				@endcan
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						@can('create-sale')
						<li><a class="{{ route_is('sales.create') ? 'active' : '' }}" href="{{route('sales.create')}}">Ajouter une vente</a></li>
						@endcan
					</ul>
				</li>
				@endcan
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ route_is('suppliers.*') ? 'active' : '' }}" href="{{route('suppliers.index')}}">Fournisseur</a></li>
						@can('create-supplier')<li><a class="{{ route_is('suppliers.create') ? 'active' : '' }}" href="{{route('suppliers.create')}}">Ajouter un fournisseur</a></li>@endcan
					</ul>
				</li>
				@endcan
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ route_is('sales.report') ? 'active' : '' }}" href="{{route('sales.report')}}">Rapport de vente</a></li>
						<li><a class="{{ route_is('purchases.report') ? 'active' : '' }}" href="{{route('purchases.report')}}">Rapport d’achat</a></li>
					</ul>
				</li>
				@endcan
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						@can('view-permission')
						<li><a class="{{ route_is('permissions.index') ? 'active' : '' }}" href="{{route('permissions.index')}}">Autorisations</a></li>
						@endcan
						@can('view-role')
